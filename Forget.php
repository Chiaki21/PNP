    ...
    if (mysqli_num_rows(mysqli_query($conx, "SELECT * FROM register WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {
            ...
            try {
                ...
                $mail->Body    = '<p> This is the password reset Link<b><a href="http://localhost/logemail/change-Password.php?Reset=' . $CodeReset . '">"http://localhost/logemail/change-Password.php?Reset=' . $CodeReset . '"</a></b></p>';
